...
while {_locationExists} do {
    ...
    _possibleInfantryTypes = arr_InfantryTypes;// + a3e_arr_Escape_InfantryTypes_Ind + a3e_arr_Escape_InfantryTypes_Ind + a3e_arr_Escape_InfantryTypes_Ind + a3e_arr_Escape_InfantryTypes_Ind;
